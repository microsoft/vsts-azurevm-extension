...
$global:RM_Extension_Status = @{
    ...
    SkippingAgentConfiguration = @{
        Code = 21
        Message = 'Skipping agent configuration, found a agent already running with same set of setting'
        operationName = 'Skip Agent Configuration'
    }
