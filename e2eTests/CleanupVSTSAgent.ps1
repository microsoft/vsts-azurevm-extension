...
{
    Remove-VSTSAgent -vstsUrl $VSTSUrl -teamProject $TeamProject -patToken $PATToken -deploymentGroupId $oldAgentInfo.deploymentGroupId -agentId $oldAgentInfo.agentId
}